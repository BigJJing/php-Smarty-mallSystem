...
<table width="972" cellpadding="0" cellspacing="0" border="0">
    ...
    {section name=nom_id loop=$nomarrs}
    <td>
        <table width="228" height="326" cellpadding="0" cellspacing="0" class="onecomm" onclick="openshowcommo({$nomarrs[nom_id].id})">
            <tr>
                <td height="228">
                    <img src="{$nomarrs[nom_id].pics}" width="228" height="228"/>
                </td> 
            </tr>
            <tr>
                <td height="40" align="left" valign="middle">
                    <a title="{$nomarrs[nom_id].name}">{$nomarrs[nom_id].name}</a>
                </td>
            </tr>
            <tr>
                <td height="58" align="left" valign="middle">
                    <span>￥{$nomarrs[nom_id].v_price}</span>
                    <font>￥{$nomarrs[nom_id].m_price}</font>
                </td>
            </tr>
        </table>
    </td>
